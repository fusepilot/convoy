# RailsAdmin config file. Generated on November 25, 2011 01:15
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Convoy', 'Admin']
  ...
  # config.excluded_models = [Folder, User, UserFile]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Folder, User, UserFile]
  ...
  #     field :user_files, :has_many_association 
  #   # Found columns:
  #     field :id, :integer 
  #     field :name, :string 
  ...
  # config.model UserFile do
  #   # Found associations:
  #     field :folder, :belongs_to_association 
  #   # Found columns:
  #     field :id, :integer 
  ...
  #     field :attachment_updated_at, :datetime         # Hidden 
  #     field :attachment, :paperclip 
  #     field :folder_id, :integer         # Hidden 
  #     field :user_id, :integer 
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime 
  #   # Sections:
